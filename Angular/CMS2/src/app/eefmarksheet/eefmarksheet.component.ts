...
@Component({
  selector: 'app-eefmarksheet',
  templateUrl: './eefmarksheet.component.html',
  styleUrls: ['./eefmarksheet.component.css']
})
export class EefmarksheetComponent implements OnInit {
